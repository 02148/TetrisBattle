...
//        FullPkgProducer pDelta = new FullPkgProducer("tcp://10.209.231.86:" + PORT + "/69420?keep",
//                "player1",
//                "delta"
//        );
//
//        FullPkgProducer pFull = new FullPkgProducer("tcp://10.209.231.86:" + PORT + "/69420?keep",
//                "player1",
//                "full"
//        );

//        var board = new BoardState(200);
//        Consumer consumerDelta = new Consumer("tcp://10.209.231.86:" + PORT + "/player1?keep", board, null, "delta");
//        Consumer consumerFull = new Consumer("tcp://10.209.231.86:" + PORT + "/player1?keep", board, null, "full");
