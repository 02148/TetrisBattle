...
public class Duplicator implements Runnable {
    ...
    public Duplicator(Space shared, Space out, Space conns, String spaceKeyIn, String spaceKeyOut) {
        this.shared = shared;
        this.out = out;
        this.conns = conns;
     ...
     * the changelist Duplicator and slower (higher) for the sync Duplicator
...
//        System.out.println("Duplicator@"+ Thread.currentThread().getId() + " finished");
    }
}
